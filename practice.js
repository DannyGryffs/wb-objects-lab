...
// let make = newObj.make
// let model = newObj.model
...
//       if (employeeObj.firstName === 'Theo'){
//         employees.splice(i, 1);
//       }else if(firstName === 'Lorie'){

//         employees[4].department = 'HR'
//         console.log(employees[4].department)
